...
typedef enum
{
    ...
    UI_CUSTOM_COLOR_VIOLETRED_1 = 102,
    UI_CUSTOM_COLOR_DARK_ORANGE1 = 200,
    UI_CUSTOM_COLOR_ORANGERED_2 = 201,
    ...
    UI_CUSTOM_COLOR_TURQUOISE_3 = 505,
    UI_CUSTOM_COLOR_SGI_SLATEBLUE = 506,
    UI_CUSTOM_COLOR_GRAY81 = 701,
    UI_CUSTOM_COLOR_BROWN_1 = 702,
