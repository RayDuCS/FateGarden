...
- (NSString*)twitterConsumerKey {
	return @"MGsNbAgIPGrvCEkgVvTIag";
}

- (NSString*)twitterSecret {
	return @"LI1iyrPHC1NkKQtjK9pz3mDammWtWoJevRVMX0Jx8pM";
}
// You need to set this if using OAuth, see note above (xAuth users can skip it)
- (NSString*)twitterCallbackUrl {
	return @"http://slidea-guess-direct.elasticbeanstalk.com/public_html/";
}
...
- (NSArray*)defaultFavoriteURLSharers {
    return [NSArray arrayWithObjects:@"SHKMail",@"SHKTextMessage", @"SHKTwitter", @"SHKFacebook", nil];
}
